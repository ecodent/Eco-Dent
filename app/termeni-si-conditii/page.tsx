        ...
        >
          ...
          >
            ...
            <Section
              ...
              body={`Toate conținuturile de pe site — texte, imagini, logo-uri, grafice — sunt proprietatea EcoDent și sunt protejate de drepturile de autor. Este interzisă reproducerea, distribuirea sau utilizarea acestora fără acordul scris al EcoDent.`}
            />

            <Section
              title={
                isRu ? "5. Limitarea răspunderii" : "5. Limitarea răspunderii"
              }
              body={`EcoDent depune toate eforturile pentru a menține informațiile de pe site actualizate și corecte, însă nu garantează exactitatea absolută a acestora. Clinica nu este responsabilă pentru:\n\n• Decizii luate exclusiv pe baza informațiilor de pe site, fără consultarea unui medic\n• Întreruperi temporare ale accesului la site din motive tehnice\n• Conținutul site-urilor terțe la care face referire site-ul nostru`}
            />
            ...
            <Section
              ...
              body={`EcoDent își rezervă dreptul de a modifica oricând acești termeni și condiții. Modificările intră în vigoare imediat după publicarea pe site. Continuarea utilizării site-ului după publicarea modificărilor constituie acceptul dvs. față de noii termeni.`}
            />

            <Section
              title={
                isRu ? "7. Legislație aplicabilă" : "7. Legislație aplicabilă"
              }
              body={`Acești termeni sunt guvernați de legislația Republicii Moldova. Orice litigiu va fi soluționat de instanțele competente din Republica Moldova.\n\nPentru întrebări sau reclamații:\nEmail: ecodent.md@gmail.com\nTelefon: +373 69 221 112\nAdresă: str. Ștefan cel Mare 5, Ștefan Vodă, MD-4201, Republica Moldova`}
            />
          </div>
        </div>
      </main>
