          ...
          {editing === i ? (
            ...
            >
              ...
              <div style={{ display: "flex", gap: "8px", marginBottom: "2px" }}>
                <button
                  style={tabBtn(lang === "ro")}
                  onClick={() => setLang("ro")}
                >
                  🇷🇴 Română
                </button>
                <button
                  style={tabBtn(lang === "ru")}
                  onClick={() => setLang("ru")}
                >
                  🇷🇺 Rusă
                </button>
                ...
                <>
                  ...
                  <div className="svc-grid-2">
                    <div>
                      ...
                      <input
                        ...
                        value={item.title_ru || ""}
                        onChange={(e) =>
                          updateItem(i, { title_ru: e.target.value })
                        }
                    ...
                    <div>
                      ...
                      <input
                        style={inputStyle}
                        value={item.subtitle_ru || ""}
                        onChange={(e) =>
                          updateItem(i, { subtitle_ru: e.target.value })
                        }
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        updateItem(i, { description_ru: e.target.value })
                      }
                  ...
                  <div>
                    ...
                    >
                      Adaugă/șterge features din tab RO.
                    </p>
                  </div>
                    ...
                    {(item.benefits_ru || []).map((b, bi) => (
                      ...
                      >
                        <input
                          ...
                          onChange={(e) => {
                            const benefits_ru = [...(item.benefits_ru || [])];
                            benefits_ru[bi] = e.target.value;
                            updateItem(i, { benefits_ru });
                          }}
                        />
                        <button
                          onClick={() =>
                            updateItem(i, {
                              benefits_ru: (item.benefits_ru || []).filter(
                                (_, idx) => idx !== bi,
                              ),
                            })
                          }
