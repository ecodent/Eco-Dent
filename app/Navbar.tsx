  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="hidden min-[1090px]:flex items-center md:ml-[56px] lg:ml-[80px] xl:ml-[120px]"
          style={{ gap: "24px" }}
        >
          <a
            href={`/${lang}`}
        ...
        <div
          className="hidden min-[1090px]:flex items-center"
        ...
        {/* Mobile hamburger */}
        <button
          className="min-[1090px]:hidden flex items-center justify-center"
